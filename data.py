...
# train_folder = "./train"
# test_folder = "./test"
train_folder = "/mnt/c/Users/b9620/Documents/Data/train"
resize_size = (64,64)
...
def construct_all_data(img_folder,mat_file_name,h5_name):
    ...
    img_bbox_data_grouped.index = range(img_bbox_data_grouped.shape[0])
    img_data.index = range(img_data.shape[0])
